...
| # | 改进项 | 原因 | 状态 |
|---|--------|------|------|
| #1 | 共享数据契约 | 阻断两个组件的正确集成 | 📋 计划中 |
| #4 | RVM 报告格式 | 阻断与 PDMS 对接 | 📋 计划中 |
| #8 | 真实 OCR 集成 | 阻断批量处理产出可信结果 | 📋 计划中 |

### P1 - 核心功能

| # | 改进项 | 原因 | 状态 |
|---|--------|------|------|
| #5 | exists 断言 | 缺少则第 1 类判据无法表达 | 📋 计划中 |
| #7 | 增量更新 | 标准换版是常见场景 | 📋 计划中 |
| #11 | 规则库扩展 | 核心业务价值 | 📋 计划中 |
...
本项目目前为个人项目，欢迎通过 GitHub Issues 讨论技术问题。
